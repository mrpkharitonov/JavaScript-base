...
function handleClick(clickedButtonEvent) {
    ...
    const card = {
        wrap: clickedButtonEvent.parentNode,  // здесь элемент с классом .product
        img: clickedButtonEvent.parentNode.querySelector("img"), // здесь картинка внутри .product
        productName: clickedButtonEvent.parentNode.querySelector(".productName"), // здесь .productName, который внутри .product
        button: clickedButtonEvent.parentNode.querySelector("button"), // здесь button, который внутри .product
    };
    console.log(card.button.innerText);
